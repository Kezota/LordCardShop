<%@ Page Title="View Transactions" Language="C#" MasterPageFile="~/Views/AppLayout.Master" AutoEventWireup="true" CodeBehind="ViewTransactions.aspx.cs" Inherits="LordCardShop.Views.Admin.ViewTransactions" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-5">
        ...
        <!-- Filter dropdown untuk memilih status transaksi -->
        ...
        <asp:GridView ID="gvTransactions" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover" OnRowCommand="gvTransactions_RowCommand">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Action">
                    <ItemTemplate>
                        <!-- Tombol View untuk melihat detail transaksi -->
