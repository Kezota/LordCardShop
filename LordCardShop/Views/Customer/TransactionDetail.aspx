<%@ Page Title="" Language="C#" MasterPageFile="~/Views/AppLayout.Master" AutoEventWireup="true" CodeBehind="TransactionDetail.aspx.cs" Inherits="LordCardShop.Views.Customer.TransactionDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-end mt-3">
            <!-- Tombol kembali ke halaman TransactionHistory -->
            <asp:Button ID="btnBack" runat="server" Text="Back to Transaction History" CssClass="btn btn-sm btn-primary" OnClick="btnBack_Click" />
        </div>
